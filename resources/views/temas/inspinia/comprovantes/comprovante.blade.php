		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F4F4B6;">
			...
			<tr>
				...
				<td style="width: 70%">
					...
					<p><i class="fa fa-calendar"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('data_pagamento') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{!! dateBdToApp($data['created_at']) !!}</span></p>
					<p><i class="fa fa-hourglass"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('hora_pagamento') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{!! explode(' ',dateTimeBdToApp($data['created_at']))[1] !!}</span></p>
					...
					@if($data['tipo'] == 'deposits')
						<p><i class="fa fa-bitcoin"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('valor_depositado') !!} (Blockchain): </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;"></b>{{ conversorMoedas($data['valor'], moeda_padrao(), 'BTC',true) }} BTCs</span></p>
						<p><i class="fa fa-folder"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('carteira_para_deposito') !!} (Blockchain): </span> <span style="font-size: 12pt !important;"> {{ $data['identificador_BTC']}}</span></p>
						<p><i class="fa fa-euro"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('moeda_utilizada') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">BTC</span></p>
						<p><i class="fa fa-check"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('confirmacoes') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{{ $data['confirmacoes_blockchain'] }}</span></p>
					@else
						<p><i class="fa fa-money"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('valor_pagamento') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{{ moeda_usuario() }} {!! conversorMoedas($data['valor'], moeda_padrao(), moeda_usuario(),true)!!}</span></p>
						...
						<p><i class="fa fa-money"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('valor_encargos') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{{ moeda_usuario() }} {!! conversorMoedas($data['valor_plataforma'],moeda_padrao(), moeda_usuario(), true) !!}</span></p>
