...
<div class="wrapper wrapper-content animated fadeIn">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <small class="stats-label">% Novas visitas</small>
                        <h4>46.11%</h4>
                    </div>
                    <div class="col-4">
                        <small class="stats-label">Semanan passada</small>
                        <h4>432.021</h4>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <small class="stats-label">Semana passada</small>
                        <h4>862.044</h4>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                ...
                <table class="table small m-t-sm">
                    <tbody>
                        <tr>
                            <td>
                                <strong>142</strong> Projetos

                            </td>
                            <td>
                                <strong>22</strong> Mensagens
                            </td>

                        </tr>
                        <tr>
                            <td>
                                <strong>61</strong> Comentários
                            </td>
                            <td>
                                <strong>54</strong> Notícias
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <strong>154</strong> Empresas
                            </td>
                            <td>
                                <strong>32</strong> Clientes
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="small float-left col-md-3 m-l-lg m-t-md">
                    <strong>Gráfico de vendas</strong> evoluíram ao longo dos anos às vezes.
                </div>
                <div class="small float-right col-md-3 m-t-md text-right">
                    <strong>Muitas</strong> Variações
                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option value="1" selected="">Completedo</option>
    ...
    <script src="/temas/inspinia/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="/temas/inspinia/js/plugins/flot/jquery.flot.time.js"></script>
