      ...
      <div class="ibox ">
        ...
        <div class="ibox-title">
          ...
          <div class="ibox-tools" style="padding-right: 5px;">
            <a class="btn-apagar btn btn-warning btn-xs float-right" data-toggle="tooltip" data-placement="top" style="margin: 0px 2px;" onclick="montaTela('{!! $url !!}')" title="{!! trataTraducoes('Voltar para a listagem') !!}">
              <i class="fa fa-mail-reply" style="color: #fff"></i>
              <span style="color: #fff">{!! trataTraducoes('Voltar para a listagem') !!}</span>
            </a>
          </div>
        </div>
