                        ...
                        <div class="ibox-content">
                            <div>
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/temas/inspinia/img/a2.jpg">
                                        </a>
                                        <div class="media-body ">
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/temas/inspinia/img/a3.jpg">
                                        </a>
                                        <div class="media-body ">
                                            <small class="float-right">2h ago</small>
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/temas/inspinia/img/a5.jpg">
                                        </a>
                                        <div class="media-body ">
                                            <small class="float-right">2h ago</small>
                ...
                <div id="tab-1" class="tab-pane active">
                    ...
                    <div>
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="float-left text-center">
                                    <img alt="image" class="rounded-circle message-avatar" src="/temas/inspinia/img/a1.jpg">
                                    <div class="m-t-xs">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="float-left text-center">
                                    <img alt="image" class="rounded-circle message-avatar" src="/temas/inspinia/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="float-left text-center">
                                    <img alt="image" class="rounded-circle message-avatar" src="/temas/inspinia/img/a3.jpg">
                                    <div class="m-t-xs">
                                        <i class="fa fa-star text-warning"></i>
                                        <i class="fa fa-star text-warning"></i>
                                        <i class="fa fa-star text-warning"></i>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="float-left text-center">
                                    <img alt="image" class="rounded-circle message-avatar" src="/temas/inspinia/img/a4.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="float-left text-center">
                                    <img alt="image" class="rounded-circle message-avatar" src="/temas/inspinia/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="float-left text-center">
                                    <img alt="image" class="rounded-circle message-avatar" src="/temas/inspinia/img/a7.jpg">
                                </div>
                                <div class="media-body">
...
<?php echo $__env->make('temas.inspinia.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\1-clientes\apis\api\resources\views/home.blade.php ENDPATH**/ ?>