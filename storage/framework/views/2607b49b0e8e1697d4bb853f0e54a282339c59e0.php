...
<body>
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="block m-t-xs font-bold"><?php echo Auth()->user()->name; ?></span>
                                <span class="text-muted text-xs block"><?php echo Auth()->user()->email; ?><b class="caret"></b></span>
                            </a>
                    ...
                    <li class="<?php echo Request::is('home') ? 'active' : Null; ?>"><a href="/home"><i class="fa fa-dashboard"></i> <span class="nav-label">Painel</span></a></li>
                    <li class="<?php echo Request::is('configuracoes') ? 'active' : Null; ?>"><a href="/configuracoes"><i class="fa fa-cogs"></i> <span class="nav-label">Configurações</span></a></li>
                    <li class="<?php echo Request::is('moedas/*') ? 'active' : Null; ?>">
                        <a href="#"><i class="fa fa-usd"></i> <span class="nav-label">Moedas</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li class="<?php echo Request::is('moedas/criptomoedas') ? 'active' : Null; ?>"><a href="/moedas/criptomoedas"><i class="fa fa-caret-right"></i> CriptoMoedas</a></li>
                            <li class="<?php echo Request::is('moedas/moedas') ? 'active' : Null; ?>"><a href="/moedas/moedas"><i class="fa fa-caret-right"></i> Moedas</a></li>
                        </ul>
                    </li>
                    <li class="<?php echo Request::is('currencylayer') ? 'active' : Null; ?>"><a href="/currencylayer"><i class="fa fa-paperclip"></i> <span class="nav-label">Dados da API</span></a></li>
                    <li class="<?php echo Request::is('ips_bloqueados') ? 'active' : Null; ?>"><a href="/ips_bloqueados"><i class="fa fa-align-justify"></i> <span class="nav-label">IP's bloqueados</span></a></li>
                    <li class="<?php echo Request::is('cadastros/*') ? 'active' : Null; ?>">
                        <a href="#"><i class="fa fa-users"></i> <span class="nav-label">Cadastros</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li class="<?php echo Request::is('cadastros/administradores') ? 'active' : Null; ?>"><a href="/cadastros/administradores"><i class="fa fa-caret-right"></i> Administradores</a></li>
                            <li class="<?php echo Request::is('cadastros/clientes') ? 'active' : Null; ?>"><a href="/cadastros/clientes"><i class="fa fa-caret-right"></i> Clientes</a></li>
                        </ul>
                    </li>
                    <li class="<?php echo Request::is('relatorios/*') ? 'active' : Null; ?>">
                        <a href="#">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li class="<?php echo Request::is('relatorios/consultas_realizadas') ? 'active' : Null; ?>"><a href="/relatorios/consultas_realizadas"><i class="fa fa-caret-right"></i> Consultas realizadas</a></li>
                            <li class="<?php echo Request::is('relatorios/consultas_por_cliente') ? 'active' : Null; ?>"><a href="/relatorios/consultas_por_cliente"><i class="fa fa-caret-right"></i> Consultas por cliente</a></li>
                        </ul>
                    </li>
            ...
            <div class="row border-bottom">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li style="padding: 20px">
                        <span class="m-r-sm text-muted welcome-message"><?php echo trataTraducoes('Bem vindo'); ?></span>
                    </li>
                    <li class="dropdown">
        ...
        </html><?php /**PATH D:\1-clientes\apis\api\resources\views/temas/inspinia/layout.blade.php ENDPATH**/ ?>