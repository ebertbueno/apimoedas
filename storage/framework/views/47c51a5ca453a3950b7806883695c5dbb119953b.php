...
<head>
	...
	<title><?php echo env('APP_NAME', ''); ?> - <?php echo app('translator')->getFromJson('general.title'); ?></title>
...
<body id="page-top">
	<div id="wrapper">
		<?php if ($__env->exists('portal.layouts.nav')) echo $__env->make('portal.layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH D:\1-clientes\apis\api\resources\views/layouts/app.blade.php ENDPATH**/ ?>