...
class RelatoriosConsultasporClienteRepositorie{

    CONST url = '/relatorios/consultas_por_cliente';

    static function index(){
        $dados['titulo_pagina'] = RelatoriosConsultasporClienteRepositorie::url;
        $dados['rota_geral'] = RelatoriosConsultasporClienteRepositorie::url;
        $dados['formulario_adicional'] = 'listagem_busca_datas_clientes';
        $datatable = [
            ['tabela'=>5,'label'=>'#','nome_no_banco_de_dados'=>'contador',],
            ['tabela'=>15,'label'=>'Cliente','nome_no_banco_de_dados'=>'users_key',],
