...
class CriptomoedasConversoes extends Model{
	use SoftDeletes;

	public $table = 'criptomoedas_conversoes';
	public $primarykey = 'id';
	public $fillable = [
		'moeda_origem','ultimo','compra','venda','timestamp','json','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
