...
class Currencylayer extends Model{
	use SoftDeletes;

	public $table = 'currencylayer';
	public $primarykey = 'id';
	public $fillable = [
		'access_key','email','senha','mes','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
